...
import TransformControls from "../repositories/TransformControls.js";
import { TeapotGeometry } from "../repositories/TeapotGeometry";

import sunflower from '../assets/textures/sunflower.jpg'
import lava from '../assets/textures/lava.png'
import blocksAmbientOcclusion from '../assets/textures/blocks_ambient_occlusion.jpg'
import blocksBump from '../assets/textures/blocks_bump.jpg'
import sands from '../assets/textures/sands.jpg'
import purplemap from '../assets/textures/lava_normal.png'
import alphaMap from '../assets/textures/alpha_map.png'
	...
	componentDidUpdate() {
		...
		switch (this.props.geometry) {
			...
			case "Hình tứ diện":
				...
				break;
			case "Hình khối 8 mặt":
				geometry = new THREE.OctahedronGeometry(0.5, 0);
				break;
			case "Hình khối 12 mặt ngũ giác":
				geometry = new THREE.DodecahedronBufferGeometry(0.5, 0);
				break;
			case "Hình khối hai mươi mặt":
		...
		switch (this.props.surface) {
			...
			case "line":
				...
				break;
			case "sunflower":
				const sunflowerTexture = new THREE.TextureLoader().load(sunflower);
                this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
                material = new THREE.MeshBasicMaterial( { map: sunflowerTexture } );
				break;
			case "lava":
				const lavaTexture = new THREE.TextureLoader().load(lava);
                this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
                material = new THREE.MeshBasicMaterial( { map: lavaTexture } );
				break;
			case "standard":
				...
				break;
			case "blocks ambient occlusion":
				var blocksAmbient = new THREE.TextureLoader().load(blocksAmbientOcclusion);
                this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
                material = new THREE.MeshBasicMaterial( { map: blocksAmbient } );
				break;
			case "blocksBump":
				var texture1 = new THREE.TextureLoader().load(blocksBump);
				this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
				material = new THREE.MeshBasicMaterial( { map: texture1 } );
				break;
			case "sands":
				var texture2 = new THREE.TextureLoader().load(sands);
				this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
				material = new THREE.MeshBasicMaterial( { map: texture2 } );
				break;
			case "purplemap":
				var texture3 = new THREE.TextureLoader().load(purplemap);
				this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
				material = new THREE.MeshBasicMaterial( { map: texture3 } );
				break;
			case "alphaMap":
				var texture4 = new THREE.TextureLoader().load(alphaMap);
				this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
				material = new THREE.MeshBasicMaterial( { map: texture4 } );
				break;
			case "scratch":
				var texture5 = new THREE.TextureLoader().load(scratch);
				this.geometry = new THREE.BoxBufferGeometry( 200, 200, 200 );
